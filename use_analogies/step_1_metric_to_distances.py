# coding=utf-8
from ystream import *
input_sv_file =  "../../datasets/my_out/out_Rus_word_ngramm_tfidf_vo.txt"
input_as_file =  "../../datasets/my_out/out_Rus_word_ngramm_tfidf_as.txt"

input_next_step = "../../datasets/my_out/out_Rus_word_ngramm_tfidf_sv.txt"

#out_vectors_file = "../../datasets/my_out/out_Rus_word_ngramm_distances_tfidf_sv.txt"
out_vectors_file = "../../datasets/my_out/out_Rus_word_ngramm_tfidf_sv_analogs.txt"
