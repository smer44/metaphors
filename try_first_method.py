...
filename = "../datasets/Rus_word_ngramm/sbj_v.txt"
    ...
    with open(filename, 'r', encoding='utf-8') as file:
        ...
        for line in file.readlines():
            ...
            if line:
                ...
                if len(spl) != 3:
                    continue
                #assert len(spl) == 3, f"!! wrong line {line}"
                #noun1, prep, noun2, times = spl
                noun1, noun2, times = spl
...
output_final = f"forward_sbj_v.txt"
with open(output_final, 'w', encoding='utf-8') as out_file:
    #distance_set_values(out_file,dictionary)
    store_dict(output_final, dictionary)